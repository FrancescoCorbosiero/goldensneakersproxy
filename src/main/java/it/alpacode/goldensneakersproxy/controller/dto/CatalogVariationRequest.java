...
/**
 * Request DTO for product variation.
 */
public class CatalogVariationRequest {
    ...
    public CatalogVariationRequest() {
    }

    /**
     * Convert to domain model.
     */
    public CatalogVariation toDomain() {
        CatalogVariation variation = new CatalogVariation();
        variation.setSku(sku);
        variation.setSize(size);
        variation.setRegularPrice(regularPrice);
        variation.setSalePrice(salePrice);
        variation.setStockQuantity(stockQuantity);
        variation.setStockStatus(stockStatus);
        variation.setWeight(weight);
        variation.setDimensions(dimensions);
